...
Cree un archivo `.env.development.local` en la raíz del proyecto. Agregue las siguientes líneas dentro:
...
Lo necesitará para que el sistema i18n funcione. Póngase en contacto con un desarrollador si necesita estos valores.
